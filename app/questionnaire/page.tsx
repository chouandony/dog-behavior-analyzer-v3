...
export default function QuestionnairePage() {
  ...
  return (
    <div className="space-y-4 pb-40">
      ...
      {/* 底部導航按鈕 */}
      <div className="fixed bottom-[calc(var(--navbar-height,3.5rem)_+_var(--disclaimer-height,5rem))] left-0 right-0 bg-white/90 backdrop-blur-md border-t border-slate-200 p-4 z-50">
