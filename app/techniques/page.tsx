  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        ...
        <h1 className="text-2xl font-black text-slate-800">訓練技術總彙</h1>
        <p className="text-sm text-slate-400 font-semibold mt-1">點擊任一技能查看詳細解說與操作方式</p>
      </div>
          ...
          <button
            ...
            className={`px-4 py-2 rounded-full text-sm font-extrabold transition-all duration-200 ${
              activeCategory === cat
                ...
                : 'bg-white/80 backdrop-blur-sm border-2 border-white shadow text-earth-500 hover:border-pink-200 hover:text-pink-500'
            }`}
          >
            {cat}
          </button>
